                ...
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <div className="flex flex-wrap gap-2 mb-2">
                      ...
                      {game.features?.find(f => f.label === 'Status')?.value === 'In Stock' ? (
                        <div className="inline-block px-3 py-1 rounded-[4px] text-sm font-bold uppercase tracking-wide bg-[#000000] text-green-400" style={{ boxShadow: '0 1px 2px rgba(0, 0, 0, 0.2)' }}>
                          In Stock
                        </div>
                      ) : (
                        <div className="inline-block px-3 py-1 rounded-[4px] text-sm font-bold uppercase tracking-wide bg-[#000000] text-red-400" style={{ boxShadow: '0 1px 2px rgba(0, 0, 0, 0.2)' }}>
                          Out of Stock
                        </div>
                      )}
                    </div>
