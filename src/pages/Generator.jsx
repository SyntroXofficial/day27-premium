...
const ServiceCard = memo(({ service, index }) => (
  ...
  >
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className="relative h-[300px] rounded-lg overflow-hidden transform transition-all duration-300 group-hover:scale-105"
    >
...
function Generator() {
  ...
  useEffect(() => {
    ...
    const subscription = db
      .from('generators')
      .on('*', (payload) => {
        fetchGenerators(); // Refresh the list when changes occur
      })
      .subscribe();
