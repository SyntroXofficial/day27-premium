        ...
        <div className="grid grid-cols-3 gap-8">
          <div className="col-span-2 space-y-6">
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="text-xl font-bold text-white mb-4">Service Access - {service.name}</h3>
              <p className="text-white/90 mb-4">
                {service.isCookie
                  ? "Click on the 'Download Cookie' button to access the required cookie files."
                  : "Click on 'Get Account' to receive your link to MEGA file and paste it into a new browser tab."}
              </p>
            ...
            {/* Service Features */}
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="text-xl font-bold text-white mb-4">Service Features</h3>
          ...
          <div className="space-y-6">
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="text-xl font-bold text-white mb-4">Service Info</h3>
